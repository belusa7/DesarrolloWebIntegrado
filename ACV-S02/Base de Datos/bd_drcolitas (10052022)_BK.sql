...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-05-2022 a las 16:30:16
...
(1, 1, 1, 1, '2022-05-13 23:59:32', 'Prueba', 1),
(2, 1, 1, 1, '2022-05-13 23:59:32', 'Prueba', 1);
...
(2, 'DNI', '52345262', 'MARIO', 'CALDERON RIVAGUERO', '65265323', 'calderon@hotmail.com', 0),
(3, 'DNI', '52321525', 'SANTIAGO', 'GOMEZ DAVILA', '4654654', 'GOMEZ@HOTMAIL.COM', 0),
(4, 'DNI', '45262358', 'JUAN', 'SILVA TORRES', '95622145', 'juan@hotmail.com', 1),
(5, 'DNI', '46465464', 'MMAXIMO', 'CARLOS', '956446', '', 0),
(6, 'DNI', '456456', 'CARLOS', 'GUILLEN ROJAS', '95645', 'carlos@hotmail.com', 1),
(7, 'DNI', '456464564', 'MARTHA', 'DIAZ DAVILA', '5956565', 'martha@hotmai.com', 1),
(9, 'DNI', '', '', '', '', '', 0);
...
(3, 2, 'DUQUE', '2021-01-01 00:00:00', 'CANINO', 'CRIOLLO', 'Hembra', 1),
(4, 3, 'MANTI', '2022-05-08 00:00:00', 'FELINO', 'CRIOLLO', 'Macho', 1),
(5, 3, 'COCO', '2022-05-17 00:00:00', 'FELINO', 'CRIOLLO', 'Hembra', 1),
(6, 1, 'FIGARO', '2022-05-01 00:00:00', 'FELINO', 'CRIOLLO', 'Hembra', 1),
(7, 1, 'FLUFFY', '2021-05-01 00:00:00', 'FELINO', 'CRIOLLO', 'Macho', 1),
(8, 3, 'COSMO', '2024-05-01 00:00:00', 'CANINO', 'CRIOLLO', 'Macho', 1),
(9, 4, 'PIPO', '2022-05-01 00:00:00', 'CANINO', 'CRIOLLO', 'Hembra', 1),
(10, 3, 'CAMILA', '2021-05-05 00:00:00', 'AVE', 'CRIOLLO', 'Hembra', 0);
...
(3, 'maritza.quispe', 'i0iDsEAozfmMq85oNspol8452sGNNlfml2IjVevkyhc=', 'q3OMY3VjAv3tZFOpB77LltQkrcLzOj', 'Asistente', 1),
(4, 'giancarlo.pulache', '/NO6A5oHLN+5e11rTiQOcoXZYQ1WITysxpppdD+Lyp4=', '1ixm3Ii01LvQPIeGfLFflxXY2hkVgO', 'Veterinario', 1),
(5, 'richard.reymundo', 'iYDA7j6nDILUiVayUv+9MUWAU1juGekdn6vRJM2HB+A=', '4OZAbODRaolRI5yNUFMeEm6SSPrMMP', 'Administrador', 0),
(6, 'jessica.james', 'f+RzJbUdO6ykffNWe9hempZ2i0PqIPFIlQeLmhxVGNY=', 'kOPq9pThFXz1Xkzzw0KaIc53vCq3Dz', 'Administrador', 0);
...
--
ALTER TABLE `cita`
  MODIFY `codigoCita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `cliente`
--
ALTER TABLE `cliente`
  MODIFY `codigoCliente` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `historia`
  MODIFY `codigoHistoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `mascota`
--
ALTER TABLE `mascota`
  MODIFY `codigoMascota` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
