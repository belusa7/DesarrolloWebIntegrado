...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-05-2022 a las 07:07:36
...
(4, 3, 'MANTI', '2022-05-08 00:00:00', 'FELINO', 'CRIOLLO', 'Hembra', 1),
...
--
ALTER TABLE `mascota`
  MODIFY `codigoMascota` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
create table historia_Detalle(
	codigodetalle int primary key  auto_increment,
     ...
     constanciAnamnesisDescripcion varchar(100) not null,
     hallazgo varchar(100) not null,
     diagnostico varchar(100) not null,
     examenauxiliar varchar(100) not null,
     tratamiento varchar(100) not null,
	proximaAtencion date not null,
    foreign key (codigoHistoria) references historia(codigoHistoria),
