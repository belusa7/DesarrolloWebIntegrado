...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2022 a las 18:35:45
...
(4, 15, 1, 1, '2022-05-17 21:00:00', '', 4),
(5, 17, 1, 1, '2022-05-17 15:30:00', '', 3),
(6, 16, 1, 1, '2022-05-19 19:00:00', 'Examen rutinario', 1),
(7, 14, 1, 1, '2022-05-19 15:30:00', '', 1),
(8, 16, 1, 1, '2022-05-21 18:00:00', 'Examen rutinario', 3);
...
(4, 'DNI', '86265350', 'JUAN', 'CANDIA RICALDE', '9562353', 'juan@hotmail.com', 1);
...
(1, 5, 4, 4, 'Normal', 'Normal 1', 'Normal 2', 'Normal 3', 'Normal 4', 'Normal 6', '2022-05-18 18:00:00'),
(2, 7, 5, 2, 'Normal', '', '', '', '', '', NULL),
(3, 6, 8, 1, 'Tº:35.3 ºC \nFC:- FR:- \nPeso:9.000 Kg', 'Perrito decaido come poco. Abdomen agrandado', 'Abdomen abalonado mucosas pálidas decaimiento \nrespiración forzada', 'ASCITIS\nERLIQUISOSIS', 'ANALISIS DE SANGRE\nECOGRAFIA ABDOMINAL', 'Fluido\nEMICINA\nDEXTROVITAM\nDIUREX\nhepatin\nANTALVET INY', NULL);
...
(1, 'bruno.paullo', 'z5xcD0zPixh9J1NC95fFkduHKrDflVj65tLuBCdWZnk=', 'zEAbhxMuSOY03WplrCYsPxFlvhhUlM', 'Administrador', 1),
...
--
ALTER TABLE `cita`
  MODIFY `codigoCita` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `historia_detalle`
  MODIFY `codigodetalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
